...
public class Db {
    ...
    public static void generate() {
        ...
        Category category2 = new Category(UUID.randomUUID(), "Telefonlar");
        Category category3 = new Category(UUID.randomUUID(), "Maishiy texnika");
        Category category4 = new Category(UUID.randomUUID(), "Mashinalar");
        categories.addAll(List.of(category1, category2, category3, category4));

        Product product1 = new Product(UUID.randomUUID(),"Notebook", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category1.getId(), user1.getId());
        Product product2 = new Product(UUID.randomUUID(),"Monitor", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category1.getId(), user1.getId());
        Product product3 = new Product(UUID.randomUUID(),"Telefon", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category2.getId(), user2.getId());
        Product product4 = new Product(UUID.randomUUID(),"Jeep", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category2.getId(), user2.getId());
        Product product5 = new Product(UUID.randomUUID(),"Stol", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category3.getId(), user3.getId());
        Product product6 = new Product(UUID.randomUUID(),"Quvvat Blogi", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category3.getId(), user3.getId());
        ...
        Product product8 = new Product(UUID.randomUUID(),"Muzlatgich", 5000 , "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic", category4.getId(), user4.getId());
        products.addAll(List.of(product1, product2, product3, product4, product5, product6, product7,product8));
